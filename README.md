...
3. Set GMAIL_USER and GMAIL_APP_PASSWORD in Render for email OTP delivery. Use a Google App Password, not the Gmail account password. If using backend SMS resend, set FAST2SMS_API_KEY too. JWT_SECRET_KEY is generated by the Blueprint.
